  ...
  return (
    <section className="max-container">
      <h1 className="head-text">
        Hello, I'm <span className="blue-gradient_text font-semibold drop-shadow">Sudharsan</span>
      </h1>

      <div className="mt-5 flex flex-col gap-3 text-slate-500">
        <p>
          Aspiring Software Engineer, Crafting and building digital experiences through code and creativity.
        </p>
      </div>
